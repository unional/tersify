...
describe('function', () => {
  ...
  test('not enough length will first trim params before body', () => {
    expect(testFunction(function (a, b, c) { return undefined })).toBe('fn(a, b, c) { return undefined; }')
    expect(testFunction(function (a, b, c) { return undefined }, { maxLength: 33 })).toBe('fn(a, b, c) { return undefined; }')
    expect(testFunction(function (a, b, c) { return undefined }, { maxLength: 32 })).toBe('fn(a, ...) { return undefined; }')
    expect(testFunction(function (a, b, c) { return undefined }, { maxLength: 31 })).toBe('fn(a,...) { return undefined; }')
    expect(testFunction(function (a, b, c) { return undefined }, { maxLength: 30 })).toBe('fn(a,..) { return undefined; }')
    expect(testFunction(function (a, b, c) { return undefined }, { maxLength: 29 })).toBe('fn(a,.) { return undefined; }')
    expect(testFunction(function (a, b, c) { return undefined }, { maxLength: 28 })).toBe('fn(a,.) { return undefi... }')
    expect(testFunction(function (a, b, c) { return undefined }, { maxLength: 17 })).toBe('fn(a,.) { re... }')
    expect(testFunction(function (a, b, c) { return undefined }, { maxLength: 16 })).toBe('fn(a,.) { re.. }')
    expect(testFunction(function (a, b, c) { return undefined }, { maxLength: 15 })).toBe('fn(a,.) { re. }')
    expect(testFunction(function (a, b, c) { return undefined }, { maxLength: 14 })).toBe('fn(a,.) { r...')
    expect(testFunction(function (a, b, c) { return undefined }, { maxLength: 13 })).toBe('fn(a,.) { ...')
    expect(testFunction(function (a, b, c) { return undefined }, { maxLength: 5 })).toBe('fn...')
    expect(testFunction(function (a, b, c) { return undefined }, { maxLength: 4 })).toBe('fn..')
    expect(testFunction(function (a, b, c) { return undefined }, { maxLength: 3 })).toBe('fn.')
    expect(testFunction(function (a, b, c) { return undefined }, { maxLength: 2 })).toBe('f.')
    expect(testFunction(function (a, b, c) { return undefined }, { maxLength: 1 })).toBe('.')
  })

  test('named function with too long signature', () => {
    const actual = testFunction(function veryVeryVeryVeryLongNameFunction(a, b, c, d, e, f, g) {
  ...
  test(`returns undefined`, () => {
    expect(testFunction(function () { return undefined })).toBe('fn() { return undefined; }')
    expect(testFunction(function () { return undefined }, { maxLength: 26 })).toBe('fn() { return undefined; }')
    expect(testFunction(function () { return undefined }, { maxLength: 25 })).toBe('fn() { return undefi... }')
  })

  test(`returns null`, () => {
    expect(testFunction(function () { return null })).toBe('fn() { return null; }')
    expect(testFunction(function () { return null }, { maxLength: 21 })).toBe('fn() { return null; }')
    expect(testFunction(function () { return null }, { maxLength: 20 })).toBe('fn() { return n... }')
  })

  test(`returns boolean`, () => {
    expect(testFunction(function () { return true })).toBe('fn() { return true; }')
    expect(testFunction(function () { return true }, { maxLength: 21 })).toBe('fn() { return true; }')
    expect(testFunction(function () { return true }, { maxLength: 20 })).toBe('fn() { return t... }')

    expect(testFunction(function () { return false })).toBe('fn() { return false; }')
    expect(testFunction(function () { return false }, { maxLength: 22 })).toBe('fn() { return false; }')
    expect(testFunction(function () { return false }, { maxLength: 21 })).toBe('fn() { return fa... }')
  })

  test(`returns number`, () => {
    expect(testFunction(function () { return 1 })).toBe('fn() { return 1; }')
    expect(testFunction(function () { return 1 }, { maxLength: 18 })).toBe('fn() { return 1; }')
    expect(testFunction(function () { return 1 }, { maxLength: 17 })).toBe('fn() { retur... }')
  })

  test(`returns bigint`, () => {
    expect(testFunction(function () { return 1n })).toBe('fn() { return 1n; }')
  })

  test(`returns string`, () => {
    expect(testFunction(function () { return 'a' })).toBe(`fn() { return 'a'; }`)
  })

  test(`returns Symbol`, () => {
    expect(testFunction(function () { return Symbol() })).toBe(`fn() { return Sym(); }`)
  })
  ...
  test(`returns RegExp`, () => {
    expect(testFunction(function () { return /foo/g })).toBe(`fn() { return /foo/g; }`)
  })
  ...
  test('return es6 simplified object', () => {
    expect(testFunction(function (x, y) { return { x, y } })).toBe('fn(x, y) { return { x, y }; }')
  })

  test('returns array', () => {
    expect(testFunction(function () { return [] })).toBe(`fn() { return []; }`)
    expect(testFunction(function () { return [1, undefined, 'a'] })).toBe(`fn() { return [1, undefined, 'a']; }`)
  })

  test('throws empty error', () => {
    expect(testFunction(function () { throw new Error() })).toBe(`fn() { throw new Error(); }`)
  })

  test('throws with message', () => {
    expect(testFunction(function () { throw new Error('abc') })).toBe(`fn() { throw new Error('abc'); }`)
  })
  ...
  test('with logical expression', () => {
    expect(testFunction(function () { return 1 && 2 })).toBe(`fn() { return 1 && 2; }`)
  })

  test('with binary expression', () => {
    expect(testFunction(function () { return (1 + 2) * 3 })).toBe(`fn() { return (1 + 2) * 3; }`)
    expect(testFunction(function () { return 3 * (1 + 2) })).toBe(`fn() { return 3 * (1 + 2); }`)
  })

  test('with update expression', () => {
    let x
    expect(testFunction(function () { return ++x })).toBe(`fn() { return ++x; }`)
    expect(testFunction(function () { return x++ })).toBe(`fn() { return x++; }`)
  })
...
describe('arrow function', () => {
  ...
  test('returns nothing', () => {
    expect(testFunction(() => { return })).toBe('() => {}')
  })

  test('returns undefined', () => {
    expect(testFunction(() => { return undefined })).toBe('() => undefined')
  })

  test('returns null', () => {
    expect(testFunction(() => { return null })).toBe('() => null')
  })

  test('returns boolean', () => {
    expect(testFunction(() => { return true })).toBe('() => true')
    expect(testFunction(() => { return false })).toBe('() => false')
  })

  test('returns number', () => {
    expect(testFunction(() => { return 1 })).toBe('() => 1')
  })

  test('returns bigint', () => {
    expect(testFunction(() => { return 1n })).toBe('() => 1n')
  })

  test('returns string', () => {
    expect(testFunction(() => { return 'a' })).toBe(`() => 'a'`)
  })

  test('returns Symbol', () => {
    expect(testFunction(() => { return Symbol() })).toBe(`() => Sym()`)
  })

  test('returns named Symbol', () => {
    expect(testFunction(() => { return Symbol.for('abc') })).toBe(`() => Sym(abc)`)
  })

  test(`returns RegExp`, () => {
    expect(testFunction(() => { return /foo/g })).toBe(`() => /foo/g`)
  })
  ...
  test('return es6 simplified object', () => {
    expect(testFunction((x, y) => { return { x, y } })).toBe('(x, y) => ({ x, y })')
  })

  test('returns array', () => {
    expect(testFunction(() => { return [] })).toBe(`() => []`)
    expect(testFunction(() => { return [1, undefined, 'a'] })).toBe(`() => [1, undefined, 'a']`)
  })
  ...
  test('with logical expression', () => {
    expect(testFunction(() => { return 1 && 2 })).toBe(`() => 1 && 2`)
  })

  test('with binary expression', () => {
    expect(testFunction(() => { return (1 + 2) * 3 })).toBe(`() => (1 + 2) * 3`)
    expect(testFunction(() => { return 3 * (1 + 2) })).toBe(`() => 3 * (1 + 2)`)
  })

  test('with update expression', () => {
    let x
    expect(testFunction(() => { return ++x })).toBe(`() => ++x`)
    expect(testFunction(() => { return x++ })).toBe(`() => x++`)
  })
  ...
  test(`async arrow function`, () => {
    const x = Promise.resolve()
    expect(testFunction(async () => { await x })).toBe('async () => { await x; }')
  })

  test('use tersify() when available', () => {
    expect(testFunction(tersible((x, y) => x + y, () => 'x + y'))).toBe('x + y')
  })
